...
<div class="flex flex-col">
  <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-lg grid grid-cols-1">
    <form class="">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-4">
        <div class="flex flex-col">
